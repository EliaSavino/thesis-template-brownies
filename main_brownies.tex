...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% START packages needed for this template %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% END packages needed for this template %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% START bibliograpy sources %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% IMPORTANT: in each chapter .tex file indicate the specific .bib file used for that chapter with \newrefsection[<bibofthischapter>]

\addbibresource{Chapter_1/References_Chapter_1.bib} %% a separate .bib file for each chapter
	%% For example, for Chapter 1, use: \newrefsection[Chapter_1/References_Chapter_1]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% START optional (re)definitions %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%% Change square root symbol %%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%% Command to allow start chapter on left page %%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% POSSIBLE redefinition of \chapter: affects also TOC %%%%%%%%%%%%%%%%%%%%%%%%%
%% Use this method when you don't mind that \chapter and TOC titlepages have the same style

%%%%%%%%%%%%%%%%%% !!! %%%%%%%%%%%%%%%%%%%
%% Will change pagestyle for both \chapter AND \tableofcontents
...
%%%%% Redefinition of \chapter that changes the default pagestyle of its titlepage from plain to self-defined chaptertitlepage (see .cls)
%\makeatletter
...
%%%%%%%%%%%%%%%%%%%%%%%%%%% Set pagestyle of chapter title %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% START definition of colours used %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%% Insert titlepage (includes firstpage) %%%%%%%%%%%%%%%%
\subfileinclude{Titlepage/titlepage}
%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%% Insert dedication if desired %%%%%%%%%%%%%%%%
\dedication{To all the wonderful Brownies using this template}

%%%% Need to add an empty page otherwise TOC starts on an even page
...
\subfileinclude{Preface/Preface}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% START summaries and acknowledgements %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% END summaries and acknowledgements %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
