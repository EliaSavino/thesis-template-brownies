...
{\ce{^1H} NMR (400 MHz, \ce{CDCl3}) δ 2.22 (t, J = 2.3 Hz, 2H), 5.56 – 5.54 (m, 8H), 7.21 – 7.28 (m, 2H), 1.11 (td, J = 3.8, 8.8 Hz, 1H), 1.02 (s, 5H); \ce{^13C} NMR (101 MHz, \ce{CDCl3}) δ 212.6, 154.3, 135.4, 125.5, 111.2, 102.3, 101.1, 54.5, 53.3, 36.2.}
